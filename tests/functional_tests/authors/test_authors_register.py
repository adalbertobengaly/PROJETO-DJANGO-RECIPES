...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def form_field_test_with_callback(self, callback):
        ...
        form.find_element(By.NAME, 'email').send_keys('anonimo@email')
    ...
    def test_password_do_not_match(self):
        def callback(form):
            ...
            form = self.get_form()
            self.assertIn('Password and password2 must be equals', form.text)
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(
            form, 'Your e-mail').send_keys('anonimo@valid.com')
        self.get_by_placeholder(
